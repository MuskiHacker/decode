# -*- coding=utf-8 -*-
# Copyright © Xtylish Pathani (Xtylish Pathani)
# Recode ? Silahkan
...
about =     '''
                ...
                {}Team              : {}ALONE QUEEN
                {}E-mail            : {}..............
                {}Github            : {}github.com/pathani-404
                {}Telegram          : {}**************
                {}Facebook          : {}xtylish.pathani.404
                {}Date              : {}10:40PM 4-May-2021
                {}Region            : {}Karachi-Pakistan'''.format(p,k,p,k,p,k,p,k,p,k,p,k,p,k,p,k,p,k,p,k,p,k,p,k,p,k)
def chat():
        load('Silahkan Tunggu Sebentar---')
	os.system('xdg-open https://www.facebook.com/xtylish.pathani.404&text=Assalamualaikum+Roy+Lu+Masih+Jual+Janda?')
kunci = '''
 	{} ▄▀▀▀▄{} *PATHANI!!
	{} █   █{} *Fb ki Queen?
	███████         ▄▀▀▄
...
def b_menu():
    bm =  '''{}╔═════════════════════════════════════════════╗
║{}[{}+{}]{}Coded    : Xtylish Pathani                ║
║{}[{}+{}]{}Github   : https://github.com/pathani404  ║
